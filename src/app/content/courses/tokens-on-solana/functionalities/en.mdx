...
It also supports multisignature accounts (requiring M-of-N signatures to authorize token operations) and provides mechanisms for freezing accounts and delegating token authority.
